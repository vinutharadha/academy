...
class WDCL_LogoCarouselChild extends WDCL_Builder_Module {
	...
	public $type                     = 'child';
	public $child_title_var          = 'brand_name';
	public $child_title_fallback_var = 'website_url';
	...
	public function get_fields() {
		...
		$fields = [
			...
			'brand_name' => [
				'label'           => esc_html__( 'Brand Name', 'wdcl-wow-divi-carousel-lite' ),
				'type'            => 'text',
				'default'         => 'Brand Name',
				'toggle_slug'     => 'main_content',
            ],
	...
	public function _render_logo() {
		...
		$data_schema   = $this->_get_swapped_img_schema( 'logo', $placeholder );
		...
		if( $this->props['is_link'] === 'on' ) {
			...
			return sprintf( '<a target="%1$s" href="%2$s" %3$s><img class="wdcl-swapped-img" data-mfp-src="%4$s" src="%4$s" alt="%5$s" %6$s /></a>',
				$target,
				$link_url,
		...
		return sprintf( '<div><img class="wdcl-swapped-img" data-mfp-src="%1$s" src="%1$s" alt="%2$s" %3$s /></div>', $logo, $brand_name, $data_schema );
	}
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		return sprintf( '<div class="wdcl-carousel-item wdcl-logo-carousel-item wdcl-swapped-img-selector">
