...
export const _getCarouselSettings = ( props, type ) => {
	...
	let content_length         = 0,
		...
		slide_count_tablet     = props.slide_count_tablet ? props.slide_count_tablet : props.slide_count,
		slide_count_phone      = props.slide_count_phone ? props.slide_count_phone : slide_count_tablet,
		nav_pagi_tablet        = props.nav_pagi_tablet ? props.nav_pagi_tablet : props.nav_pagi,
		nav_pagi_phone         = props.nav_pagi_phone ? props.nav_pagi_phone : nav_pagi_tablet,
		is_pagi_active         = props.nav_pagi === "pagi" || props.nav_pagi === "nav_pagi" ? true : false,
		...
		is_arrow_active        = props.nav_pagi === "nav" || props.nav_pagi === "nav_pagi" ? true : false,
        ...
        is_auto_height         = slide_count < 2 && is_variable_width === 'off'  && is_auto_height === 'on' ? true : false;
		...
		if( type !== 'jQuery' ) {
			...
			slide_infinite         = content_length >= slide_count && props.is_infinite === "on" ? true : false;
			slide_infinite_tablet  = content_length >= slide_count_tablet && props.is_infinite === "on" ? true : false;
			slide_infinite_phone   = content_length >= slide_count_phone && props.is_infinite === "on" ? true : false;
		} else {
	...
	let settings = {
        ...
        centerPadding  : is_variable_width === 'off' && center_mode_type === 'classic' ? center_padding : 0,
		...
		responsive     : [
			{
				...
				settings: {
                    ...
                    centerPadding  : is_variable_width === 'off' && center_mode_type === 'classic' ? center_padding_tablet : 0,
			...
			},
			{
				...
				settings: {
                    ...
                    centerPadding  : is_variable_width === 'off' && center_mode_type === 'classic' ? center_padding_phone : 0,
...
export const _getCarouselCss = ( props ) => {
	...
	const additionalCss                          = [];
        ...
        let arrow_height                              = props.arrow_height,
            arrow_height_tablet                       = props.arrow_height_tablet ? props.arrow_height_tablet : arrow_height,
            arrow_height_phone                        = props.arrow_height_phone ? props.arrow_height_phone : arrow_height_tablet,
            arrow_width                               = props.arrow_width,
            arrow_width_tablet                        = props.arrow_width_tablet ? props.arrow_width_tablet : arrow_width,
            arrow_width_phone                         = props.arrow_width_phone ? props.arrow_width_phone : arrow_width_tablet,

            arrow_color                               = props.arrow_color,
            arrow_color__hover                        = props.arrow_color__hover ? props.arrow_color__hover : arrow_color,
            arrow_bg                                  = props.arrow_bg,
            arrow_bg__hover                           = props.arrow_bg__hover ? props.arrow_bg__hover : arrow_bg,
            arrow_icon_size                           = props.arrow_icon_size,
            arrow_icon_size_tablet                    = props.arrow_icon_size_tablet ? props.arrow_icon_size_tablet : arrow_icon_size,
            arrow_icon_size_phone                     = props.arrow_icon_size_phone ? props.arrow_icon_size_phone : arrow_icon_size_tablet,
            ...
            arrow_border_color__hover                 = props.arrow_border_color__hover ? props.arrow_border_color__hover : arrow_border_color,
            arrow_border_style                        = props.arrow_border_style,
            arrow_pos_y                               = props.arrow_pos_y,
            arrow_pos_y_tablet                        = props.arrow_pos_y_tablet ? props.arrow_pos_y_tablet : arrow_pos_y,
            arrow_pos_y_phone                         = props.arrow_pos_y_phone ? props.arrow_pos_y_phone : arrow_pos_y_tablet,
            arrow_x_center                            = props.arrow_x_center,
            arrow_pos_x                               = props.arrow_pos_x,
            arrow_pos_x_tablet                        = props.arrow_pos_x_tablet ? props.arrow_pos_x_tablet : arrow_pos_x,
            arrow_pos_x_phone                         = props.arrow_pos_x_phone ? props.arrow_pos_x_phone : arrow_pos_x_tablet,
            arrow_type                                = props.arrow_type,
            arrow_pos                                 = props.arrow_pos,
            arrow_pos_hz                              = props.arrow_pos_hz,
            arrow_gap                                 = props.arrow_gap,
            arrow_gap_tablet                          = props.arrow_gap_tablet ? props.arrow_gap_tablet : arrow_gap,
            arrow_gap_phone                           = props.arrow_gap_phone ? props.arrow_gap_phone : arrow_gap_tablet,

            arrow_skew                                = props.arrow_skew,
            int_skew                                  = parseInt(arrow_skew),
            arrow_skew_inner                          = (int_skew < 0) ? `${Math.abs(int_skew)}` : `-${Math.abs(int_skew)}`,

            pagi_alignment                            = props.pagi_alignment,
            pagi_color                                = props.pagi_color,
            pagi_color__hover                         = props.pagi_color__hover ? props.pagi_color__hover : pagi_color,
            ...
            slide_width_responsive_status             = props.slide_width_last_edited && props.slide_width_last_edited.startsWith("on"),
            ...
            carousel_spacing_top_responsive_status    = props.carousel_spacing_top_last_edited && props.carousel_spacing_top_last_edited.startsWith("on"),
            ...
            carousel_spacing_bottom_responsive_status = props.carousel_spacing_bottom_last_edited && props.carousel_spacing_bottom_last_edited.startsWith("on");
        ...
        // alongside arrow type
            ...
            if( arrow_x_center && arrow_x_center === 'on' ) {
                ...
                additionalCss.push( [{
                    selector: "%%order_class%% .slick-next",
                    declaration: `right: calc(50% - ${ parseInt(arrow_width) + (parseInt(arrow_gap)/2) }px);`
                }]);

                additionalCss.push( [{
                    selector: "%%order_class%% .slick-prev",
                    declaration: `left: calc(50% - ${ parseInt(arrow_width) + (parseInt(arrow_gap)/2) }px);`
                }]);
                ...
                additionalCss.push( [{
                    selector: "%%order_class%% .slick-next",
                    device: "tablet",
                    declaration: `right: calc(50% - ${ parseInt(arrow_width_tablet) + (parseInt(arrow_gap_tablet)/2) }px);`
                }]);

                additionalCss.push( [{
                    selector: "%%order_class%% .slick-prev",
                    device: "tablet",
                    declaration: `left: calc(50% - ${ parseInt(arrow_width_tablet) + (parseInt(arrow_gap_tablet)/2) }px);`
                }]);
                ...
                additionalCss.push( [{
                    selector: "%%order_class%% .slick-next",
                    device: "phone",
                    declaration: `right: calc(50% - ${ parseInt(arrow_width_phone) + (parseInt(arrow_gap_phone)/2) }px);`
                }]);

                additionalCss.push( [{
                    selector: "%%order_class%% .slick-prev",
                    device: "phone",
                    declaration: `left: calc(50% - ${ parseInt(arrow_width_phone) + (parseInt(arrow_gap_phone)/2) }px);`
                }]);
...
export const _getCustomBgCss = ( props, opt_name, selector, hover_selector ) => {
    ...
    let use_background_color_gradient = props[opt_name+'_bg_use_color_gradient'] || 'off';
    let _bg_gradient_overlays_image   = props[opt_name+'_bg_color_gradient_overlays_image'] || 'off';


    if ( 'on' === use_background_color_gradient ) {

        let _bg_gradient_type             = props[opt_name+'_bg_color_gradient_type'] || 'linear';
        let _bg_gradient_direction        = props[opt_name+'_bg_color_gradient_direction'] || '180deg';
        let _bg_gradient_radial_direction = props[opt_name+'_bg_color_gradient_direction_radial'] || 'center';
        let _bg_gradient_color_start      = props[opt_name+'_bg_color_gradient_start'] || '#2b87da';
        let _bg_gradient_color_end        = props[opt_name+'_bg_color_gradient_end'] || '#29c4a9';
        let _bg_gradient_start_position   = props[opt_name+'_bg_color_gradient_start_position'] || '0%';
        let _bg_gradient_end_position     = props[opt_name+'_bg_color_gradient_end_position'] || '100%';



        _bg_gradient_direction            = _bg_gradient_type === 'linear' ? _bg_gradient_direction : `circle at ${_bg_gradient_radial_direction}`;
    ...
    if ( ! has_bg_color_gradient ) {
        ...
        if (typeof props[opt_name+'_bg_color'] !== 'undefined' ) {
            _bg_style += `background-color: ${ props[opt_name+'_bg_color'] } !important;`;
        }
    }
    ...
    if( _hover_enabled ) {
        ...
        // A. Background Gradient.
        let use_background_color_gradient_hover = props[opt_name+'_bg_use_color_gradient__hover'] || 'off';
        let _bg_gradient_overlays_image_hover   = props[opt_name+'_bg_color_gradient_overlays_image__hover'] || 'off';

        if ( 'on' === use_background_color_gradient_hover || props[opt_name+'_bg_color_gradient_start__hover'] ) {

            let _bg_gradient_type_hover             = props[opt_name+'_bg_color_gradient_type__hover'] || 'linear';
            let _bg_gradient_direction_hover        = props[opt_name+'_bg_color_gradient_direction__hover'] || '180deg';
            let _bg_gradient_radial_direction_hover = props[opt_name+'_bg_color_gradient_direction_radial__hover'] || 'circle';
            let _bg_gradient_color_start_hover      = props[opt_name+'_bg_color_gradient_start__hover'] || '#2b87da';
            let _bg_gradient_color_end_hover        = props[opt_name+'_bg_color_gradient_end__hover'] || '#29c4a9';
            let _bg_gradient_start_position_hover   = props[opt_name+'_bg_color_gradient_start_position__hover'] || '0%';
            let _bg_gradient_end_position_hover     = props[opt_name+'_bg_color_gradient_end_position__hover'] || '100%';

            _bg_gradient_direction_hover = _bg_gradient_type_hover === 'linear' ? _bg_gradient_direction_hover : `circle at ${_bg_gradient_radial_direction_hover}`;
        ...
        if ( _bg_images_hover !== '' ) {
            ...
            // Set background image styles only it's different compared to the larger device.
            _bg_style_hover += `background-image: ${ _bg_images_hover.join( ', ') } !important;`;
        }

        if ( ! has_bg_color_gradient_hover ) {
            // The background color
            if (typeof props[opt_name+'_bg_color__hover'] !== 'undefined' ) {
                _bg_style_hover += `background-color: ${ props[opt_name+'_bg_color__hover'] } !important;`;
            }
        }
...
export const _getOverlayStyleCss = ( props ) =>  {
    ...
    let additionalCss      = [],
        overlay_icon_color           = props.overlay_icon_color ? props.overlay_icon_color : '#2EA3F2',
        overlay_icon_color__hover    = props.overlay_icon_color__hover,
        overlay_icon_size            = props.overlay_icon_size ? props.overlay_icon_size : '32px',
        overlay_icon_size__hover     = props.overlay_icon_size__hover,
        overlay_icon_opacity         = props.overlay_icon_opacity ? props.overlay_icon_opacity : '1',
    ...
    // Overlay Background
    let overlay_bg_style = _getCustomBgCss( props, 'overlay', "%%order_class%% .wdcl-overlay", "%%order_class%% .wdcl-carousel-item:hover .wdcl-overlay" );
