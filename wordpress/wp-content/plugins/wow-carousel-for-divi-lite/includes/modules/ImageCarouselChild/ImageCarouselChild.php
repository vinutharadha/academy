...
class WDCL_ImageCarouselChild extends WDCL_Builder_Module {
    ...
    public function init() {
        ...
        $this->settings_modal_toggles = [
			'general' =>  [
				'toggles'  =>  [
					'carousel_content'  =>  [
						'title'				=>	esc_html('Content', 'wdcl-wow-divi-carousel-lite'),
					]
				],
            ],
			...
			'advanced'	=> [
				'toggles'  =>  [
					'image'  =>  [
						'title' =>	esc_html('Image', 'wdcl-wow-divi-carousel-lite'),
					],
					'overlay'  =>  [
						'title' =>	esc_html('Overlay', 'wdcl-wow-divi-carousel-lite'),
					],
					'content'  =>  [
						'title' =>	esc_html('Content', 'wdcl-wow-divi-carousel-lite'),
					],
					'texts'  =>  [
						'title' =>	esc_html('Texts', 'wdcl-wow-divi-carousel-lite'),
						'tabbed_subtoggles'	=>	true,
						'sub_toggles'		=>	[
							'title_tab'	=>	[
								'name'	=>	esc_html('Title', 'wdcl-wow-divi-carousel-lite')
							],
							'subtitle_tab'	=>	[
								'name'	=>	esc_html('Subtitle', 'wdcl-wow-divi-carousel-lite')
							]
						]
                    ],
                    'borders'  =>  [
						'title'				=>	esc_html('Border', 'wdcl-wow-divi-carousel-lite'),
					],
				],
			]
		];
	...
	public function get_fields() {
		...
		return array_merge( $fields, $content, $overlay );
	}
	...
	public function _render_figure() {
		...
		return sprintf( '<figure>
				...
				<img class="wdcl-main-img" src="%1$s" alt=""/>
            </figure>', $photo, $overlay_icon );
	...
	public function _render_content() {
		...
		return sprintf( '<div class="content content--%3$s content--%4$s"><div class="content-inner"> %1$s %2$s </div></div>',
			$this->_render_title(),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( $content_type === 'absolute' ) {
			ET_Builder_Element::set_style( $render_slug, array(
				...
				'declaration' => sprintf( 'align-items: %1$s; justify-content: %2$s;',
					$content_pos_x,
					$content_pos_y
				),
			) );
		...
		ET_Builder_Element::set_style( $render_slug, array(
            ...
            'declaration' => sprintf( 'width: %1$s; %2$s',
                $content_width,
		...
		return sprintf( '<div class="wdcl-carousel-item wdcl-image-carousel-item wdcl-swapped-img-selector wdcl-hover--%3$s">
				%1$s %2$s
			</div>',
			$this->_render_figure(),
